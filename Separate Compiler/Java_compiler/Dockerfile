...
# Open port for httpd access on local
EXPOSE 80

# set working directory
WORKDIR /var/www/localhost/htdocs
RUN chmod -R 777 /var/www/localhost/htdocs && chmod -R 777 /usr/local/bin/
#RUN chmod -R 777 /var/www/localhost/htdocs
COPY 'Java_compiler' /var/www/localhost/htdocs

# run-apache2.sh for heroku deployment
